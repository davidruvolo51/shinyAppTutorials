...
module.exports = {
  ...
  "select-input-list-item": "select-input-list-item",
...
$.extend(selectInput, {
  ...
  subscribe: function subscribe(el, callback) {
    ...
    var menuIsOpen = menuList.attr("aria-hidden") === "false"; // define event that open/closes the input list

    selectMenu.on("click", "button.select-list-toggle", function (e) {
      // toggle menu state
      selectMenu.toggleClass("hidden"); // adjust select Input List; scroll, aria

      menuList.scrollTop(0);
      menuIsOpen = !menuIsOpen;
      menuList.attr("aria-hidden", menuIsOpen); // if the menu is open, set selected text to a default message
    ...
    selectMenu.on("click", "button.input-button", function (e) {
      ...
      selectMenu.find("button.input-button").removeClass("selected"); // select click element + extract data
      ...
      newElem.addClass("selected"); // update el's input value

      selectMenu.data("value", newValue.value); // update select input toggle text and close menu
      ...
      menuList.scrollTop(0);
      menuIsOpen = !menuIsOpen;
      menuList.attr("aria-hidden", menuIsOpen); // run callback
    ...
    $(btns).on("focus", function (e) {
      ...
      selectMenu.removeClass("hidden"); // prep for final element blur (i.e., exited from focus)
      ...
      if (e.target.nextSibling) {
        $(lastBtn).on("blur", function (e) {
          // close menu
          selectMenu.addClass("hidden"); // adjust select Input List; scroll, aria
